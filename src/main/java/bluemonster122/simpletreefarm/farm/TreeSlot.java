package bluemonster122.simpletreefarm.farm;
...
public class TreeSlot {
    ...
    public TreeSlot(BlockPlanks.EnumType TYPE, boolean isMega, int minHeight, int chanceHeight, int additionalChanceHeight) {
        this.TYPE = TYPE;
